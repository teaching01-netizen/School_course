...
func TestProjectedAbsenceSessionLimitExceeded(t *testing.T) {
	tests := []struct {
		...
		{
			name:                   "9 sessions, 0 existing, submitting 1 = 11% allowed",
			totalSessions:          9,
			existingMissedSessions: 0,
			submittingSessionCount: 1,
			wantExceeded:           false,
		...
		{
			name:                   "9 sessions, 0 existing, submitting 2 = 22% allowed (round(9/5)=2)",
			totalSessions:          9,
			existingMissedSessions: 0,
			submittingSessionCount: 2,
			wantExceeded:           false,
		...
		{
			name:                   "9 sessions, 0 existing, submitting 3 = 33% blocked",
			totalSessions:          9,
			existingMissedSessions: 0,
			submittingSessionCount: 3,
			wantExceeded:           true,
		...
		{
			name:                   "9 sessions, 1 existing, submitting 1 = 22% allowed (round(9/5)=2)",
			totalSessions:          9,
			existingMissedSessions: 1,
			submittingSessionCount: 1,
			wantExceeded:           false,
		...
		{
			name:                   "9 sessions, 2 existing, submitting 1 = 33% blocked",
			totalSessions:          9,
			existingMissedSessions: 2,
			submittingSessionCount: 1,
			wantExceeded:           true,
