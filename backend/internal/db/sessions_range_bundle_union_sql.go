...
NULL::uuid, '', NULL::uuid, NULL::uuid, '', '', NULL::uuid, '', '', NULL::text, 0::smallint, NULL::uuid, NULL::uuid, NULL::jsonb, '', false, NULL::timestamptz, NULL::timestamptz
FROM course_students cs
JOIN courses c ON c.id = cs.course_id
...
UNION ALL
SELECT 2 AS tag, NULL::uuid, '', '', NULL::uuid, '', '', NULL, 0, NULL::uuid, NULL::uuid, NULL::uuid, '', false,
m.id, m.rule_id, m.course_id, m.merge_group_id,
