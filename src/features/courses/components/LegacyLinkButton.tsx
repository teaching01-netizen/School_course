        ...
        <div className="space-y-2 p-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="min-w-0 flex-1 rounded-sm border border-[var(--color-wi-line)] px-2.5 py-1.5 text-sm transition-colors duration-150 placeholder:text-[var(--color-wi-faint)] focus:border-[var(--color-wi-primary)] focus:ring-3 focus:ring-[var(--color-wi-primary)]/15 focus-visible:outline-none"
            />
