  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="block w-full pl-8 pr-8 py-1.5 text-sm border border-[var(--color-wi-line)] rounded-sm bg-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
      />
      {internalValue && (
        <button
          onClick={handleClear}
