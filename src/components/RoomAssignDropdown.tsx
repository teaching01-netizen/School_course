        ...
        >
          ...
          <div className="px-1.5 pb-1">
            <input
              ...
              className="h-8 w-full rounded-sm border border-wi-line px-2.5 text-sm placeholder:text-[var(--color-wi-faint)] focus-visible:outline-none focus:border-[var(--color-wi-primary)] focus:ring-3 focus:ring-[var(--color-wi-primary)]/15"
            />
          </div>
          {hasNoResults ? (
