...
export default function TemplateEditor({ subject, body, onChange, name, onNameChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      {onNameChange && (
        <div>
          <label className="block text-sm font-medium text-[var(--color-wi-text-light)] mb-1">Template name</label>
          <input
            type="text"
            value={name ?? ""}
      ...
      <div>
        <label className="block text-sm font-medium text-[var(--color-wi-text-light)] mb-1">Subject line</label>
        <div className="flex gap-1">
          <input
            ...
            className="flex-1 rounded-sm border border-[var(--color-wi-line)] p-2 text-sm font-mono"
      ...
      <div>
        <label className="block text-sm font-medium text-[var(--color-wi-text-light)] mb-1">Email body</label>
        <div className="space-y-2">
          <textarea
            ...
            rows={12}
            className="w-full rounded-sm border border-[var(--color-wi-line)] p-2 text-sm font-mono resize-y"
