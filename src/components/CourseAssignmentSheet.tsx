...
export default function CourseAssignmentSheet({
  ...
  if (courses.length === 0) {
    return (
      <div className="border-t border-t-[var(--color-wi-line)] pt-3 mt-4">
    ...
    <div className="border-t border-t-[var(--color-wi-line)] pt-3 mt-4">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {courses.map((course) => (
              <tr key={course.id} className="border-b border-b-[var(--color-wi-line)] hover:bg-[var(--color-wi-row-alt)]">
