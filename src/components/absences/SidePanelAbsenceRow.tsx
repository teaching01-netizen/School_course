    ...
    <article className={`rounded-sm border border-wi-line-soft border-l-2 bg-white p-3 text-sm shadow-sm ${absenceInlineClasses(absence)}`}>
      ...
      <div className="mt-3 flex justify-end">
        <Link
          ...
          className="inline-flex min-h-[28px] items-center rounded-sm border border-wi-line bg-white px-2 py-1 text-xs font-medium text-[var(--color-wi-text-light)] hover:bg-[var(--color-wi-row-alt)]"
        >
          View details
        </Link>
      </div>
