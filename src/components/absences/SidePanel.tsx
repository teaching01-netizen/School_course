    ...
    <AnimatePresence>
      ...
      >
        <header className="sticky top-0 z-10 border-b border-b-[var(--color-wi-line)] bg-white">
          ...
          {!studentAbsence ? (
            <div className="flex border-t border-t-[var(--color-wi-line)] px-4">
              <button
                type="button"
                ...
                <section className="space-y-2">
                  ...
                  {sessions.length === 0 ? (
                    ...
                    sessions.map((session) => (
                      <article key={session.id} className="rounded-sm border border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] p-3 text-sm">
                        ...
                        {session.sit_in_students?.length ? (
                          <p className="mt-2 border-t border-t-[var(--color-wi-line)] pt-2 text-xs text-[var(--color-wi-amber)]">
