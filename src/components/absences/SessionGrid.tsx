...
export default function SessionGrid({
  ...
  if (subjects.length === 0) {
    return (
      <div className="rounded-sm border border-[var(--color-wi-line)] bg-white p-5 text-center text-gray-650 font-medium">
    ...
    <div className="space-y-4">
      ...
      <label className="flex items-center gap-2 cursor-pointer select-none text-sm font-medium text-[var(--color-wi-text-light)]">
        <input
          ...
          className="h-4 w-4 rounded border-[var(--color-wi-line)] text-green-600 focus:ring-green-500"
        />
        All selected
      </label>
      ...
      {subjects.map((subject) => {
        ...
        return (
          <div
            ...
            className="rounded-sm border border-[var(--color-wi-line)] bg-white overflow-hidden"
          >
            {/* Subject header */}
            <div className="flex items-center gap-2 border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] px-4 py-2.5">
              <input
                type="checkbox"
                role="checkbox"
