      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex flex-wrap gap-1">
            <span className="rounded-full border border-[var(--color-wi-line)] bg-white px-2 py-0.5 text-[10px] text-[var(--color-wi-text-light)]">{getSitInLabel(absence)}</span>
            <span className="rounded-full border border-[var(--color-wi-line)] bg-white px-2 py-0.5 text-[10px] text-[var(--color-wi-text-light)]">{absence.sit_in_method ?? "pending"}</span>
          </div>
