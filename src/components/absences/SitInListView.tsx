    ...
    <div className="overflow-hidden rounded-sm border border-[var(--color-wi-line)] bg-white">
      <div className="overflow-x-auto">
        <table className="min-w-full text-left">
          <thead className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] text-xs font-semibold text-[var(--color-wi-text-light)]">
            <tr>
      ...
      {visibleCount < rows.length ? (
        <div className="border-t border-t-[var(--color-wi-line)] p-3 text-center">
