      ...
      <div className="rounded-sm border border-red-200 bg-red-50 p-3 text-sm text-red-800">
        ...
        <div className="mt-2 flex gap-2">
          ...
          {onSkip && (
              <button
                type="button"
                className="min-h-[44px] rounded-sm border border-[var(--color-wi-line)] bg-white px-3 py-2 text-xs font-medium text-[var(--color-wi-text-light)] transition-colors hover:bg-[var(--color-wi-row-alt)]"
                onClick={onSkip}
              >
                Skip
              </button>
