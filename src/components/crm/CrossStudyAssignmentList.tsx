    ...
    <div>
      <div className="flex items-end gap-2 mb-3">
        <div>
          ...
          <select
            ...
            className="px-2 py-1.5 text-sm border border-[var(--color-wi-line)] rounded-sm"
          >
            {statusOptions.map((o) => (
      ...
      {loading && assignments.length === 0 ? (
        ...
        <div className="border border-[var(--color-wi-line)] rounded-sm overflow-hidden">
          <table className="w-full text-[12px]">
            ...
            <tbody>
              {assignments.map((a) => (
                <tr
                  key={a.id}
                  className="border-b border-b-[var(--color-wi-line)] hover:bg-blue-50 cursor-pointer"
          ...
          <div className="flex items-center justify-between gap-2 border-t border-t-[var(--color-wi-line)] px-2 py-1.5">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                className="px-2 py-1 text-xs border border-[var(--color-wi-line)] rounded-sm disabled:opacity-40"
