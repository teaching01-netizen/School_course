  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className="w-full text-left px-2 py-1 text-xs border border-[var(--color-wi-line)] rounded-sm bg-white hover:bg-[var(--color-wi-row-alt)]"
      >
        {safeSelected.length === 0 ? "Any" : `${safeSelected.length} selected`}
      </button>
      {open && (
        <div className="absolute z-10 mt-1 w-56 max-h-48 overflow-y-auto border border-[var(--border-strong)] rounded-sm bg-white shadow">
  ...
  return (
    <div>
      ...
      <select
        ...
        className="w-full px-2 py-1 text-xs border border-[var(--color-wi-line)] rounded-sm bg-white"
      >
...
export default function CrmFilterPanel({ courseId, isAdmin, onRosterChanged, embeddedInModal = false }: Props) {
  ...
  return (
    <div className={embeddedInModal ? "" : "border border-[var(--border-strong)] rounded-sm p-4 mb-6"}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-2 mb-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-2 py-1 text-xs border border-[var(--color-wi-line)] rounded-sm"
          />
        </div>
      </div>
            ...
            <button
              ...
              className={`px-3 py-1 text-xs rounded-sm border ${
                locked
                  ...
                  : "border-[var(--color-wi-line)] text-[var(--color-wi-text-light)] hover:bg-[var(--color-wi-row-alt)]"
              }`}
            >
