    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 px-2 py-1.5 text-sm border border-[var(--color-wi-line)] rounded-sm"
        />
        <Button
          variant="primary"
          size="sm"
        ...
        <>
          <div className="border border-[var(--color-wi-line)] rounded-sm">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] text-left text-[var(--color-wi-text-light)]">
              ...
              <tbody>
                {paged.map((g: GroupWithCount) => (
                  <tr key={g.id} className="border-b border-b-[var(--color-wi-line)] hover:bg-[var(--color-wi-row-alt)]">
                      ...
                      {editingGroupId === g.id ? (
                        <div className="flex items-center gap-1">
                          <input
                            ...
                            className="flex-1 px-2 py-1 text-sm border border-[var(--color-wi-line)] rounded-sm"
                            autoFocus
                          />
                          <button
