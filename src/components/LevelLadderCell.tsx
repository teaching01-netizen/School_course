...
const statusStyles: Record<CellStatus, string> = {
  active: "border-[var(--color-wi-line)] bg-white hover:border-blue-300",
  vacant: "border-dashed border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] hover:border-blue-400",
