...
export default function WeekSummary({ totalSessions, totalAbsences, totalSitIns }: WeekSummaryProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-1.5 sm:flex sm:flex-wrap">
      <span className="inline-flex items-center justify-center gap-1 rounded-sm border var(--color-wi-line) px-2 py-1 text-[11px] text-[var(--color-wi-text-light)] sm:justify-start">
      ...
      <span className={`inline-flex items-center justify-center gap-1 rounded-sm border px-2 py-1 text-[11px] sm:justify-start ${
        totalAbsences > 0 ? 'border-red-200 text-red-700' : 'var(--color-wi-line) text-[var(--color-wi-text-light)]'
      }`}>
      ...
      <span className={`inline-flex items-center justify-center gap-1 rounded-sm border px-2 py-1 text-[11px] sm:justify-start ${
        totalSitIns > 0 ? 'border-amber-200 text-amber-700' : 'var(--color-wi-line) text-[var(--color-wi-text-light)]'
      }`}>
