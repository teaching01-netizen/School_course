    ...
    <section className="border border-[var(--color-wi-primary)]/30 bg-white p-5" aria-labelledby="live-import-heading" aria-live="polite">
      ...
      {percent !== null ? (
        <div className="mt-5">
          ...
          <div className="mt-2 h-2 overflow-hidden rounded-full border border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]" role="progressbar" aria-label="Legacy import progress" aria-valuemin={0} aria-valuemax={100} aria-valuenow={percent}>
      ...
      <dl className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="border border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] px-3 py-2">
      ...
      <div className="mt-4 flex flex-wrap justify-between gap-2 border-t border-t-[var(--color-wi-line)] pt-3 text-xs text-[var(--color-wi-text-light)]">
