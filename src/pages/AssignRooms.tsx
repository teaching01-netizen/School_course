  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div>
          <div className="grid grid-cols-[88px_minmax(0,1fr)_152px_minmax(240px,auto)] items-center gap-4 border-b border-b-[var(--color-wi-line)] px-3 pb-1.5 text-[11px] font-semibold uppercase tracking-wide text-[var(--color-wi-text-light)]">
            <span>Time</span>
            <span>Subject</span>
            <span>Teacher</span>
