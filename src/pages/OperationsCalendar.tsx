...
export default function OperationsCalendar() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-4 rounded-sm border border-[var(--color-wi-line)] bg-white px-4 py-2.5 text-sm text-[var(--color-wi-text-light)]">
      ...
      <section className="mb-4 rounded-sm border border-[var(--color-wi-line)] bg-white p-3">
      ...
      {viewMode === "list" ? (
        ...
        <div className="rounded-sm border border-[var(--color-wi-line)] bg-white">
          <EmptyState
            message={
              showMode === "sit-ins"
        ...
        <div className="overflow-hidden rounded-sm border border-[var(--color-wi-line)] bg-white" style={{ minHeight: "300px" }}>
          <div className="grid grid-cols-7 border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] text-center text-[10px] font-semibold uppercase tracking-wider text-[var(--color-wi-text-light)]">
          ...
          <div className="grid grid-cols-7">
            {monthGrid.map((day) => {
              ...
              return (
                <div
                  key={dayStr}
                  className={`min-h-[80px] border-b border-r border-r-[var(--color-wi-line)] p-1 last:border-r-0 ${isToday ? "ring-1 ring-inset ring-[var(--color-wi-primary)]" : ""} ${!isCurrentMonth ? "bg-[var(--color-wi-row-alt)]" : ""}`}
                >
                  <button
                    type="button"
        ...
        <div
          className="grid grid-cols-7 gap-px overflow-hidden rounded-sm border border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]"
            ...
            return (
              ...
              >
                <button
                  ...
                  onClick={() => openPanel(dayStr)}
                  aria-label={`Open details for ${dayLabel}`}
                  className={`sticky top-0 z-10 border-b border-b-[var(--color-wi-line)] px-2 py-2 text-center ${isToday ? "bg-[var(--color-wi-blue-bg)]" : ""}`}
                >
                ...
                <div className="flex-1 space-y-1 overflow-y-auto p-1.5">
                  {daySessions.map((session) => (
                    <button
                      ...
                      className="w-full rounded-sm border border-[var(--color-wi-line)] bg-white px-2 py-1.5 text-left text-xs shadow-sm transition-shadow hover:shadow-md"
                    >
                      ...
                      {session.sit_in_students && session.sit_in_students.length > 0 ? (
                        <div className="mt-1 border-t border-t-[var(--color-wi-line)] pt-1">
