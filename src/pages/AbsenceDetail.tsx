  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-2 flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="hidden md:flex flex-wrap items-center gap-2 rounded-sm border border-[var(--border-strong)] bg-white p-3 shadow-sm md:flex-nowrap">
      ...
      <div className="mt-4 grid gap-4">
        <section className="rounded-sm border border-[var(--color-wi-line)] bg-white">
          <h2 className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]/70 px-4 py-3 text-sm font-semibold text-[var(--color-wi-text)]">Absence Summary</h2>
        ...
        <section className="rounded-sm border border-[var(--color-wi-line)] bg-white">
          <h2 className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]/70 px-4 py-3 text-sm font-semibold text-[var(--color-wi-text)]">Sit-in Plan</h2>
          <div className="p-4">
                ...
                {(() => {
                  return groupByInstituteDay(absence.sit_ins).map((group) => {
                    if (group.items.length > 1) {
                      ...
                      return (
                        <div key={group.start_at} className="flex items-center justify-between rounded-sm border border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] px-3 py-2 text-sm">
                    ...
                    return (
                      <div key={s.id} className="flex items-center justify-between rounded-sm border border-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)] px-3 py-2 text-sm">
        ...
        <div className="grid gap-4">
          <section className="rounded-sm border border-[var(--color-wi-line)] bg-white">
            <h2 className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]/70 px-4 py-3 text-sm font-semibold text-[var(--color-wi-text)]">Admin Notes</h2>
            <div className="p-4">
          ...
          <section className="rounded-sm border border-[var(--color-wi-line)] bg-white">
            <h2 className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]/70 px-4 py-3 text-sm font-semibold text-[var(--color-wi-text)]">Timeline</h2>
            <div className="p-4">
      ...
      {cancelOpen ? (
        <Modal title="Cancel absence" onClose={() => setCancelOpen(false)}
          ...
          <select id="detail-cancel-category" className="mt-1 w-full rounded-sm border border-[var(--color-wi-line)] p-2 text-sm" value={cancelReasonCategory} onChange={(e) => setCancelReasonCategory(e.target.value)}>
          ...
          <textarea id="detail-cancel-detail" className="mt-1 w-full rounded-sm border border-[var(--color-wi-line)] p-2 text-sm" rows={3} value={cancelReasonDetail} onChange={(e) => setCancelReasonDetail(e.target.value)} />
        </Modal>
      ) : null}
