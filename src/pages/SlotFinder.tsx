...
export default function SlotFinder() {
  ...
  return (
    <div>
      ...
      {/* Search Form */}
      <div className="bg-[var(--color-wi-row-alt)] border border-[var(--color-wi-line)] rounded-sm p-4 mb-6">
          ...
          <div>
            <label className="block text-xs text-[var(--color-wi-text-light)] mb-1">
              ...
              <input
                ...
                className="mt-1 w-full px-2 py-1.5 text-sm border border-[var(--color-wi-line)] rounded-sm"
              />
            </label>
          </div>
          <div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {daysInRange.map((dateStr) => {
              ...
              return (
                <div key={dateStr} className="border border-[var(--color-wi-line)] rounded-sm overflow-hidden">
                  <div className="bg-[var(--color-wi-row-alt)] border-b border-b-[var(--color-wi-line)] px-4 py-2 flex items-center justify-between">
                    <div>
