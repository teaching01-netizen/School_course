        ...
        >
          <div className="space-y-3">
            ...
            <div>
              ...
              <textarea value={form.notes} onChange={(e) => setForm({ ...form, notes: e.target.value })} className="w-full px-2 py-1.5 text-sm border border-[var(--color-wi-line)] rounded-sm" rows={3} />
            </div>
          </div>
        </Modal>
      )}
