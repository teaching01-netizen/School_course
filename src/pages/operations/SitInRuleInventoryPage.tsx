  ...
  return (
    <div>
      ...
      {rules.length === 0 ? (
        ...
        <div className="rounded-sm border border-[var(--border-strong)] bg-white shadow-sm overflow-hidden">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-b-[var(--color-wi-line)] bg-[var(--color-wi-row-alt)]/70 text-left text-[var(--color-wi-text-light)]">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-sm border border-[var(--color-wi-line)] px-3 py-2 text-sm focus:border-[var(--color-wi-primary)] focus:outline-none"
