      ...
      {loading ? (
        ...
        <div className="border var(--color-wi-line) rounded-sm overflow-x-auto">
          <table className="w-full text-[13px] data-table">
            ...
            <tbody>
              {items.map((it) => (
                <tr key={it.id} className="border-b var(--color-wi-line) last:border-b-0 align-top">
                  ...
                  <td className="py-2 px-2">
                    <pre className="text-[11px] bg-[var(--color-wi-row-alt)] border var(--color-wi-line) rounded-sm p-2 overflow-auto max-h-40">
